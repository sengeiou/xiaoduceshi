...
//import ai.qiwu.com.xiaoduhome.entity.primary.GameProjectTb;
//import ai.qiwu.com.xiaoduhome.entity.primary.OnProductDetail;
...
//import static ai.qiwu.com.xiaoduhome.common.Constants.XIAOWU_API.FLOWER_INTERFACE;
 ...
 */
@Slf4j
public class DplBotRedisService extends BaseBot {
...
//
    public DplBotRedisService(HttpServletRequest request, Integer type,StringRedisTemplate stringRedisTemplate) throws IOException {
        super(request);
//        this.type = type;
...
//            stringRedisTemplate.delete(SpiritRedisService.PREFIX_REDIS+customUserId());
//            String welcomeWord;
//            String skillName;
...
//
//            try {
//                Future<Response> future = DplbotServiceUtil.getPOOL().submit(() -> dealNoScreenIntentTemp(intentRequest, userId));
////                Response response = future.get(2700, TimeUnit.MILLISECONDS).getResponse();
...
////    }
//
//    private Response dealNoScreenIntentTemp(IntentRequest intentRequest, String userId) {
//        String intentName = getIntent().getName();
//        if ("sendFlower".equals(intentName)) {
//            return dealNoScreenSendFlowerIntent(userId);
...
////                });
////            }
//            log.info("Redis 写入:"+path);
//            stringRedisTemplate.opsForValue().set(SpiritRedisService.PREFIX_REDIS+userId, path, 10, TimeUnit.SECONDS);
//            return new Response();
//        } catch (Exception e) {
//            log.warn("中控返回结果为空:"+e);
//            return buildErrorResponse(ErrorMsg.SORRY_UNCATCH);
...
//    }
//
//    private Response dealNoScreenSendFlowerIntent(String userId) {
...
//    @Override
//    protected Response onDefaultEvent() {
//        if (getRequest().getRequest() instanceof AudioPlayerEvent) {
//            this.setExpectSpeech(true);
//            return new Response();
//        }
//        return new Response();
