...
import com.baidu.dueros.data.response.directive.SendPart;
...
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.BACK_TRACE;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.COLLECTED_IMG_URL;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.COLLEC_ID;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.FLOWE;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.FLOWER_LOAD;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.NEXT_PAGE_INDEX;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.PRE_CATEGORY;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.PRE_COLLE;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.UN_COLLECTED_IMG_URL;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.UN_COLLEC_ID;
...
import static ai.qiwu.com.xiaoduhome.common.Constants.LOAD_INTRO;
...
import static ai.qiwu.com.xiaoduhome.common.Constants.PRODUCT_INTRO.COLLECED;
import static ai.qiwu.com.xiaoduhome.common.Constants.PRODUCT_INTRO.COLLECT_BOT_WORD;
import static ai.qiwu.com.xiaoduhome.common.Constants.PRODUCT_INTRO.COLLECT_BOT_WORD_MG;
import static ai.qiwu.com.xiaoduhome.common.Constants.PRODUCT_INTRO.FLOWER;
import static ai.qiwu.com.xiaoduhome.common.Constants.PRODUCT_INTRO.UN_COLLEC;
import static ai.qiwu.com.xiaoduhome.common.Constants.PRODUCT_INTRO.UN_COLLECT_BOT_WORD;
import static ai.qiwu.com.xiaoduhome.common.Constants.PRODUCT_INTRO.UN_COLLECT_BOT_WORD_MG;
import static ai.qiwu.com.xiaoduhome.common.Constants.PRODUCT_INTRO.USER_SEND_FLOWER;
...
import static ai.qiwu.com.xiaoduhome.common.Constants.WelcomeWord.ERROR_SEND_FLOWER;
...
import static ai.qiwu.com.xiaoduhome.common.Constants.WelcomeWord.SKILL_LITERATURE;
...
import static ai.qiwu.com.xiaoduhome.common.Constants.WelcomeWord.SKILL_STORY;
...
//                log.info("BASE_HOST_URL:"+finalBaseHost);
    ...
    private Response dealNoScreenIntentTemp(IntentRequest intentRequest, String userId, String baseUrl,
...
//        content = buildText(content);
    ...
    private Response dealStartIntent(String userId, IntentRequest intentRequest, String channelId) {
        String trace = getSessionAttribute("trace");
...
//            }
    ...
    private Response dealDefaultIntent(IntentRequest intentRequest, String userId, String word, String channelId) {
        if (word == null) {
...
//                }
    ...
    protected Response onDefaultEvent() {
        RequestBody requestBody = getRequest().getRequest();
        if (requestBody instanceof AudioPlayerEvent) {
            this.setExpectSpeech(true);
            return new Response();
        }
        return new Response();
