...
import com.baidu.dueros.data.response.directive.dpl.commands.ScrollToElementCommand;
import com.baidu.dueros.data.response.directive.dpl.commands.ScrollToIndexCommand;
import com.baidu.dueros.data.response.directive.dpl.commands.UpdateDataSourceCommand;
...
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.CATEGORY_NAME;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.CUR_FIRST_ROW_INDEX;
...
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.SCROLL_ID;
import static ai.qiwu.com.xiaoduhome.common.Constants.DPL_COMPONENT_ID.START_ACTUAL_INDEX;
        ...
        try {
            switch (componentId) {
                ...
                case DPL2.TRIGGER_HOME_PAGE_LOAD: {
                    openRandomHome();
                    return buildTextResponse(Constants.WelcomeWord.WELCOME);
                }
...
//    }
    ...
    private Response dealOpenProductDetail(ProjectData productDetail, boolean collect) {
        try {
            ...
            data.setLabel(Constants.PRODUCT_INTRO.LABEL+String.join(PRODUCT_INTRO.SPACE, productDetail.getLabels()));
