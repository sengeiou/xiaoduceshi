...
public class AskForPermissionsConsent extends Directive {
    ...
    private List<com.baidu.dueros.data.response.directive.permission.Permission> permissions = new ArrayList<>();
    ...
    public AskForPermissionsConsent addPermission(String name) {
        com.baidu.dueros.data.response.directive.permission.Permission permission = new com.baidu.dueros.data.response.directive.permission.Permission(name);
        permissions.add(permission);
        return this;
    }

    public List<com.baidu.dueros.data.response.directive.permission.Permission> getPermissions() {
        return permissions;
    }
