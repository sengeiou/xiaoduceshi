...
public abstract class BaseTemplate {
    ...
    // 背景图片
    private com.baidu.dueros.data.response.directive.display.templates.ImageStructure backgroundImage = new com.baidu.dueros.data.response.directive.display.templates.ImageStructure();
    // 卡片的标题
     ...
     */
    public com.baidu.dueros.data.response.directive.display.templates.ImageStructure getBackgroundImage() {
     ...
     * @return BaseTemplate
     */
    public BaseTemplate setBackgroundImage(com.baidu.dueros.data.response.directive.display.templates.ImageStructure backgroundImage) {
