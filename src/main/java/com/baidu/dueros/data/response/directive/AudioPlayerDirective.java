...
public class AudioPlayerDirective extends Directive {
    ...
    // 多媒体信息
    private com.baidu.dueros.data.response.directive.AudioItem audioItem;

    /**
     * 默认构造方法
     */
    public AudioPlayerDirective() {
        audioItem = new com.baidu.dueros.data.response.directive.AudioItem();
    }
     ...
     *            多媒体信息
     */
    public AudioPlayerDirective(final PlayBehaviorType playBehavior, final com.baidu.dueros.data.response.directive.AudioItem audioItem) {
    ...
    public AudioPlayerDirective(String url) {
        audioItem = new com.baidu.dueros.data.response.directive.AudioItem(url);
    }
    ...
    public AudioPlayerDirective(final PlayBehaviorType playBehavior, final String url, final int offsetInMilliSeconds) {
        this.playBehavior = playBehavior;
        com.baidu.dueros.data.response.directive.AudioItem audioItem = new com.baidu.dueros.data.response.directive.AudioItem(url, offsetInMilliSeconds);
        this.audioItem = audioItem;
    }
     ...
     */
    public com.baidu.dueros.data.response.directive.AudioItem getAudioItem() {
        return audioItem;
    }
