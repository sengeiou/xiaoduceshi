...
public class Tpl1Content {
    ...
    // 文字内容
    private com.baidu.dueros.data.response.directive.display.templates.TextStructure text;
     ...
     *            文字内容
     */
    public Tpl1Content(com.baidu.dueros.data.response.directive.display.templates.TextStructure text) {
        this.text = text;
        // 默认置底左对齐
    ...
    public Tpl1Content(TextType type, String text) {
        this.text = new com.baidu.dueros.data.response.directive.display.templates.TextStructure(type, text);
        // 默认置底左对齐
        this.position = PositionType.BOTTOM_LEFT;
    }
    ...
    public Tpl1Content(String text) {
        this.text = new com.baidu.dueros.data.response.directive.display.templates.TextStructure(TextType.PlainText, text);
        // 默认置底左对齐
        this.position = PositionType.BOTTOM_LEFT;
    }
     ...
     */
    public com.baidu.dueros.data.response.directive.display.templates.TextStructure getText() {
        return text;
    }
