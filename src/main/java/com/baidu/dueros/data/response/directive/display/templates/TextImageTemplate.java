...
public abstract class TextImageTemplate extends BaseTemplate {
    // 展现的图片
    private com.baidu.dueros.data.response.directive.display.templates.ImageStructure image;
    // 文本结构，支持纯文本和富文本两种格式
     ...
     */
    public com.baidu.dueros.data.response.directive.display.templates.ImageStructure getImage() {
        return image;
    }
     ...
     */
    public TextImageTemplate setImage(com.baidu.dueros.data.response.directive.display.templates.ImageStructure image) {
        this.image = image;
        return this;
    }
