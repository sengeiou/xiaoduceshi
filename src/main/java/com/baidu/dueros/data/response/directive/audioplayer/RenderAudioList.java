...
public class RenderAudioList extends Directive {
    ...
    private long size;
    // 列表项目信息
    private ArrayList<com.baidu.dueros.data.response.directive.audioplayer.RenderAudioListAudioItem> audioItems = new ArrayList<>();
    ...
    public ArrayList<com.baidu.dueros.data.response.directive.audioplayer.RenderAudioListAudioItem> getAudioItems() {
        return audioItems;
    }

    public void setAudioItems(ArrayList<com.baidu.dueros.data.response.directive.audioplayer.RenderAudioListAudioItem> audioItems) {
        this.audioItems = audioItems;
    }

    public void addAudioItem(com.baidu.dueros.data.response.directive.audioplayer.RenderAudioListAudioItem audioItem) {
