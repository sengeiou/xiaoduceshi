...
public class ResponseBody {
    ...
    private List<com.baidu.dueros.data.response.directive.Directive> directives = new ArrayList<>();
     ...
     *            Card内容
     */
    public ResponseBody(final OutputSpeech outputSpeech, final Reprompt reprompt, com.baidu.dueros.data.response.card.Card card) {
     ...
     */
    public List<com.baidu.dueros.data.response.directive.Directive> getDirectives() {
        return directives;
    }
