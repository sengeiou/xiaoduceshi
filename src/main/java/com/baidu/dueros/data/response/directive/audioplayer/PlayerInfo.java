...
public class PlayerInfo {
    ...
    // 控件列表
    private ArrayList<com.baidu.dueros.data.response.directive.audioplayer.control.BaseButton> controls = new ArrayList<>();
     ...
     *            控件列表
     */
    public PlayerInfo(Content content, ArrayList<com.baidu.dueros.data.response.directive.audioplayer.control.BaseButton> controls) {
     ...
     */
    public ArrayList<com.baidu.dueros.data.response.directive.audioplayer.control.BaseButton> getControls() {
        return controls;
    }
     ...
     * @return PlayerInfo
     */
    public PlayerInfo setControls(ArrayList<com.baidu.dueros.data.response.directive.audioplayer.control.BaseButton> controls) {
        this.controls = controls;
        return this;
    }
