...
public class AudioPlayerDirective extends Directive {
    ...
    // 多媒体信息
    private com.baidu.dueros.data.response.directive.audioplayer.AudioItem audioItem;

    /**
     * 默认构造方法
     */
    public AudioPlayerDirective() {
        audioItem = new com.baidu.dueros.data.response.directive.audioplayer.AudioItem();
    }
    ...
    public AudioPlayerDirective(String url) {
        audioItem = new com.baidu.dueros.data.response.directive.audioplayer.AudioItem(url);
    }
     ...
     *            多媒体信息
     */
    public AudioPlayerDirective(final PlayBehaviorType playBehavior, final com.baidu.dueros.data.response.directive.audioplayer.AudioItem audioItem) {
    ...
    public AudioPlayerDirective(final PlayBehaviorType playBehavior, final String url, final int offsetInMilliSeconds) {
        this.playBehavior = playBehavior;
        com.baidu.dueros.data.response.directive.audioplayer.AudioItem audioItem = new com.baidu.dueros.data.response.directive.audioplayer.AudioItem(url, offsetInMilliSeconds);
        this.audioItem = audioItem;
    }
     ...
     */
    public com.baidu.dueros.data.response.directive.audioplayer.AudioItem getAudioItem() {
        return audioItem;
    }
