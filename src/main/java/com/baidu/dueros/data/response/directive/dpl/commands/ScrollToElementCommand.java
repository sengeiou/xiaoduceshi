...
public class ScrollToElementCommand extends BaseCommand {
    ...
    private com.baidu.dueros.data.response.directive.dpl.commands.ScrollToIndexCommand.AlignType align;
    ...
    public com.baidu.dueros.data.response.directive.dpl.commands.ScrollToIndexCommand.AlignType getAlign() {
        return align;
    }
