...
public class UserEvent extends CommonEvent {
    ...
    // payload
    private final com.baidu.dueros.data.response.directive.dpl.event.Payload payload;
    ...
    private UserEvent(@JsonProperty("requestId") final String requestId,
            ...
            @JsonProperty("payload") final com.baidu.dueros.data.response.directive.dpl.event.Payload payload) {
    ...
    public com.baidu.dueros.data.response.directive.dpl.event.Payload getPayload() {
        return payload;
    }
    ...
    public static final class Builder extends RequestBodyBuilder<Builder, UserEvent> {
        ...
        private com.baidu.dueros.data.response.directive.dpl.event.Payload payload;
