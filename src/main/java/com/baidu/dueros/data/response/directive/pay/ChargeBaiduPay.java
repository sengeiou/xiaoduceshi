...
public class ChargeBaiduPay {
    ...
    private com.baidu.dueros.data.response.directive.pay.AuthorizeAttributes authorizeAttributes = new com.baidu.dueros.data.response.directive.pay.AuthorizeAttributes();
