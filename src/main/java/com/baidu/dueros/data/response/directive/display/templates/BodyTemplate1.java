...
public class BodyTemplate1 extends BaseTemplate {
     ...
     *            文字内容
     */
    public BodyTemplate1(String title, TextStructure.TextType textType, String text) {
        super(title);
    ...
    public BodyTemplate1 setPlainContent(String textContent) {
        this.textContent = new Tpl1Content(TextStructure.TextType.PlainText, textContent);
        return this;
    }
