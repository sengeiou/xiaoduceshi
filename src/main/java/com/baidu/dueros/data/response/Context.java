...
public class Context {
    ...
    private List<com.baidu.dueros.data.response.ExpectResponse> expectResponse = new ArrayList<com.baidu.dueros.data.response.ExpectResponse>();
    ...
    public void setExpectResponses(List<com.baidu.dueros.data.response.ExpectResponse> expectResponses) {
