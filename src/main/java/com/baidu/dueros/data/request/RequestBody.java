...
@JsonSubTypes({ @Type(value = IntentRequest.class), @Type(value = LaunchRequest.class),
        ...
        @Type(value = PlaybackQueueClearedEvent.class), @Type(value = com.baidu.dueros.data.request.events.ElementSelectedEvent.class),
        @Type(value = com.baidu.dueros.data.request.events.LinkClickedEvent.class), @Type(value = com.baidu.dueros.data.request.events.ConnectionsResponseEvent.class),
        ...
        @Type(value = com.baidu.dueros.data.request.events.ButtonClickedEvent.class), @Type(value = RadioButtonClickedEvent.class),
