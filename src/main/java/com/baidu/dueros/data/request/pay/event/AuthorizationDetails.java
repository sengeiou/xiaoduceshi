...
public class AuthorizationDetails {
    ...
    private com.baidu.dueros.data.request.pay.event.AuthorizationAmount authorizationAmount;
    private com.baidu.dueros.data.request.pay.event.CapturedAmount capturedAmount;
     ...
     *            capturedAmount
     */
    private AuthorizationDetails(@JsonProperty("authorizationAmount") final com.baidu.dueros.data.request.pay.event.AuthorizationAmount authorizationAmount,
            @JsonProperty("capturedAmount") final com.baidu.dueros.data.request.pay.event.CapturedAmount capturedAmount,
     ...
     */
    public com.baidu.dueros.data.request.pay.event.AuthorizationAmount getAuthorizationAmount() {
     ...
     */
    public com.baidu.dueros.data.request.pay.event.CapturedAmount getCapturedAmount() {
