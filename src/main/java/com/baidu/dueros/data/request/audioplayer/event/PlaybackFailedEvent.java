...
public class PlaybackFailedEvent extends AudioPlayerEvent {
    ...
    // 错误信息
    private final com.baidu.dueros.data.request.audioplayer.event.Error error;
    ...
    private PlaybackFailedEvent(@JsonProperty("requestId") final String requestId,
            ...
            @JsonProperty("error") final com.baidu.dueros.data.request.audioplayer.event.Error error) {
     ...
     */
    public com.baidu.dueros.data.request.audioplayer.event.Error getError() {
        return error;
    }
    ...
    public static final class Builder extends RequestBodyBuilder<Builder, PlaybackFailedEvent> {
        ...
        private com.baidu.dueros.data.request.audioplayer.event.Error error;
