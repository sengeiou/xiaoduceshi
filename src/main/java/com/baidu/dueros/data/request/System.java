...
public class System {
    ...
    // 用户信息
    private final com.baidu.dueros.data.request.User user;
    // Bot信息
    private final com.baidu.dueros.data.request.Application application;
    // 端上设备信息
    private final com.baidu.dueros.data.request.Device device;
    // apiAccessToken
    ...
    private System(@JsonProperty("user") final com.baidu.dueros.data.request.User user, @JsonProperty("application") final com.baidu.dueros.data.request.Application application,
                   @JsonProperty("device") final com.baidu.dueros.data.request.Device device, @JsonProperty("apiAccessToken") final String apiAccessToken,
     ...
     * @return User 用户信息
     */
    public com.baidu.dueros.data.request.User getUser() {
        return user;
    }
     ...
     */
    public com.baidu.dueros.data.request.Application getApplication() {
        return application;
    }
     ...
     */
    public com.baidu.dueros.data.request.Device getDevice() {
        return device;
    }
    ...
    public static final class Builder {
        ...
        private com.baidu.dueros.data.request.User user;
        private com.baidu.dueros.data.request.Application application;
        private com.baidu.dueros.data.request.Device device;
