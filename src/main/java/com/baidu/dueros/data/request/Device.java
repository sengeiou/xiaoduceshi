...
public class Device {
    ...
    // 设备信息
    private final com.baidu.dueros.data.request.DeviceInfo deviceInfo;
    // 原始的设备Id
    ...
    private Device(@JsonProperty("deviceId") final String deviceId,
            @JsonProperty("deviceInfo") final com.baidu.dueros.data.request.DeviceInfo deviceInfo,
     ...
     */
    public com.baidu.dueros.data.request.DeviceInfo getDeviceInfo() {
        return deviceInfo;
    }
    ...
    public static final class Builder {
        ...
        // 设备信息
        private com.baidu.dueros.data.request.DeviceInfo deviceInfo;
        // 原始的设备Id
