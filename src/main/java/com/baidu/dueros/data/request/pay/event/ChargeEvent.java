...
public class ChargeEvent extends ConnectionsResponseEvent {
    ...
    private com.baidu.dueros.data.request.pay.event.Payload payload;
     ...
     */
    public com.baidu.dueros.data.request.pay.event.Payload getPayload() {
        return payload;
    }
    ...
    public ChargeEvent(@JsonProperty("requestId") final String requestId,
            ...
            @JsonProperty("token") final String token, @JsonProperty("payload") final com.baidu.dueros.data.request.pay.event.Payload payload) {
