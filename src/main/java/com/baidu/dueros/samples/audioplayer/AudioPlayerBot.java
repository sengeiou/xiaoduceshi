...
public class AudioPlayerBot extends AudioPlayer {
     ...
     * @param launchRequest
     *            LaunchRequest请求体
     * @see com.baidu.dueros.bot.BaseBot#onLaunch(LaunchRequest)
     */
    @Override
     ...
     * @see AudioPlayer#onPlaybackNearlyFinishedEvent(PlaybackNearlyFinishedEvent)
     */
    @Override
     ...
     * 
     * @see AudioPlayer#onPlaybackStartedEvent(PlaybackStartedEvent)
     */
    @Override
