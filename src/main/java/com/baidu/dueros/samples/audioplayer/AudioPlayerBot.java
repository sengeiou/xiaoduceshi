...
public class AudioPlayerBot extends AudioPlayer {
    ...
    protected Response onLaunch(LaunchRequest launchRequest) {
        ...
        // 构造TextCard
        com.baidu.dueros.data.response.card.TextCard textCard = new com.baidu.dueros.data.response.card.TextCard();
    ...
    protected Response onInent(IntentRequest intentRequest) {
        if ("play".equals(intentRequest.getIntentName())) {
            com.baidu.dueros.data.response.directive.Play play = new com.baidu.dueros.data.response.directive.Play("https://.mp3");
            ...
            com.baidu.dueros.data.response.directive.audioplayer.RenderAudioListAudioItem renderAudioListAudioItem1 = new com.baidu.dueros.data.response.directive.audioplayer.RenderAudioListAudioItem();
            ...
            com.baidu.dueros.data.response.directive.audioplayer.RenderAudioListAudioItem renderAudioListAudioItem2 = new RenderAudioListAudioItem();
            ...
            com.baidu.dueros.data.response.directive.audioplayer.RenderAudioList renderAudioList = new RenderAudioList();
     ...
     * @see AudioPlayer#onPlaybackNearlyFinishedEvent(com.baidu.dueros.data.request.audioplayer.event.PlaybackNearlyFinishedEvent)
     */
    @Override
    protected Response onPlaybackNearlyFinishedEvent(PlaybackNearlyFinishedEvent playbackNearlyFinishedEvent) {
        ...
        // 新建Play指令
        com.baidu.dueros.data.response.directive.Play play = new com.baidu.dueros.data.response.directive.Play(AudioPlayerDirective.PlayBehaviorType.ENQUEUE, "url", 1000);
        // 添加返回的指令
        this.addDirective(play);
     ...
     * 
     * @see AudioPlayer#onPlaybackStartedEvent(com.baidu.dueros.data.request.audioplayer.event.PlaybackStartedEvent)
     */
    @Override
    protected Response onPlaybackStartedEvent(PlaybackStartedEvent playbackStartedEvent) {

        com.baidu.dueros.data.response.card.TextCard textCard = new TextCard();
        ...
        com.baidu.dueros.data.response.directive.Play play = new Play(AudioPlayerDirective.PlayBehaviorType.ENQUEUE, "url", 1000);
