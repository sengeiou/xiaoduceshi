...
public class PermissionBot extends BaseBot {
    ...
    protected Response onLaunch(LaunchRequest launchRequest) {
        ...
        com.baidu.dueros.data.response.card.TextCard textCard = new TextCard("欢迎来到测试权限");
    ...
    protected Response onInent(IntentRequest intentRequest) {
        ...
        if ("permission".equals(intentRequest.getIntentName())) {
            ...
            com.baidu.dueros.data.response.directive.permission.AskForPermissionsConsent askForPermissionsConsent = new AskForPermissionsConsent();
