...
public class VideoPlayerBot extends VideoPlayer {
    ...
    protected Response onInent(IntentRequest intentRequest) {
        ...
        if ("video_play_intent".equals(intentRequest.getIntentName())) {
            com.baidu.dueros.data.response.directive.videoplayer.Play play = new com.baidu.dueros.data.response.directive.videoplayer.Play("http:.....mp4");
            ...
            com.baidu.dueros.data.response.directive.videoplayer.RenderVideoListVideoItem renderVideoListVideoItem = new com.baidu.dueros.data.response.directive.videoplayer.RenderVideoListVideoItem();
            ...
            renderVideoListVideoItem.setImage(new com.baidu.dueros.data.response.directive.videoplayer.Image("http:.....png"));
            renderVideoListVideoItem.setToken("123");

            com.baidu.dueros.data.response.directive.videoplayer.RenderVideoListVideoItem renderVideoListVideoItem1 = new RenderVideoListVideoItem();
            ...
            com.baidu.dueros.data.response.directive.videoplayer.RenderVideoList renderVideoList = new com.baidu.dueros.data.response.directive.videoplayer.RenderVideoList();
            renderVideoList.setBehavior(com.baidu.dueros.data.response.directive.videoplayer.RenderVideoList.RenderVideoListPlayBehaviorType.REPLACE);
        ...
        // 判断NLU解析的意图名称是否匹配 video_stop_intent
            ...
            com.baidu.dueros.data.response.directive.videoplayer.Stop stop = new Stop();
        ...
        // 判断NLU解析的意图名称是否匹配 video_stop_intent
            ...
            com.baidu.dueros.data.response.directive.videoplayer.ClearQueue clear = new ClearQueue("CLEAR_ALL");
