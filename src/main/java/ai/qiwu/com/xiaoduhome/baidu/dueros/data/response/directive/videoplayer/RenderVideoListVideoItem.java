...
package ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer;
...
public class RenderVideoListVideoItem {
    ...
    // 视频缩略图
    private ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.Image image;
    ...
    public ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.Image getImage() {
        return image;
    }
