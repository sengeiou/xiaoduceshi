...
package ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.audioplayer.event;
...
public class PlaybackFailedEvent extends AudioPlayerEvent {
    ...
    // 错误信息
    private final ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.audioplayer.event.Error error;
    ...
    private PlaybackFailedEvent(@JsonProperty("requestId") final String requestId,
            ...
            @JsonProperty("error") final ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.audioplayer.event.Error error) {
     ...
     */
    public ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.audioplayer.event.Error getError() {
        return error;
    }
    ...
    public static final class Builder extends RequestBodyBuilder<Builder, PlaybackFailedEvent> {
        ...
        private ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.audioplayer.event.Error error;
