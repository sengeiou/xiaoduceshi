...
public abstract class TextImageTemplate extends BaseTemplate {
    // 展现的图片
    private ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.display.templates.ImageStructure image;
    // 文本结构，支持纯文本和富文本两种格式
     ...
     *            文字内容
     */
    public TextImageTemplate(String title, TextStructure.TextType textType, String text) {
        super(title);
     ...
     */
    public ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.display.templates.ImageStructure getImage() {
        return image;
    }
     ...
     */
    public TextImageTemplate setImage(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.display.templates.ImageStructure image) {
        this.image = image;
        return this;
    }
