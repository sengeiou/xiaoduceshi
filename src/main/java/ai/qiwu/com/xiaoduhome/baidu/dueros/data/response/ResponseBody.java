...
package ai.qiwu.com.xiaoduhome.baidu.dueros.data.response;
...
public class ResponseBody {
    ...
    private List<ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.Directive> directives = new ArrayList<>();
     ...
     *            Card内容
     */
    public ResponseBody(final OutputSpeech outputSpeech, final Reprompt reprompt, ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.Card card) {
     ...
     */
    public List<ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.Directive> getDirectives() {
        return directives;
    }
