...
package ai.qiwu.com.xiaoduhome.baidu.dueros.samples.permission;
...
public class PermissionBot extends BaseBot {
    ...
    protected Response onLaunch(LaunchRequest launchRequest) {
        ...
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard textCard = new TextCard("欢迎来到测试权限");
    ...
    protected Response onInent(IntentRequest intentRequest) {
        ...
        if ("permission".equals(intentRequest.getIntentName())) {
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.permission.AskForPermissionsConsent askForPermissionsConsent = new AskForPermissionsConsent();
