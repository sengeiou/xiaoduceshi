...
import ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.events.ConnectionsResponseEvent;
...
public class ChargeEvent extends ConnectionsResponseEvent {
    ...
    private ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.pay.event.Payload payload;
     ...
     */
    public ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.pay.event.Payload getPayload() {
        return payload;
    }
    ...
    public ChargeEvent(@JsonProperty("requestId") final String requestId,
            ...
            @JsonProperty("token") final String token, @JsonProperty("payload") final ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.pay.event.Payload payload) {
