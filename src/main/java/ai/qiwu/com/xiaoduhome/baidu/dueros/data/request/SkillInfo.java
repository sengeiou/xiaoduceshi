...
public class SkillInfo {
    // 技能图标信息
    private final ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.Icon icon;
    // 技能名称
     ...
     *            技能名称
     */
    private SkillInfo(@JsonProperty("icon") final ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.Icon icon, @JsonProperty("name") final String name) {
        this.icon = icon;
        this.name = name;
    }
     ...
     * @return Icon 技能图标信息
     */
    public ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.Icon getIcon() {
        return icon;
    }
    ...
    public static final class Builder {
        // 技能图标信息
        private ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.Icon icon;
        // 技能名称
        private String name;
