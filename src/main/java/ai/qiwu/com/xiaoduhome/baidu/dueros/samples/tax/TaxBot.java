...
package ai.qiwu.com.xiaoduhome.baidu.dueros.samples.tax;

import java.io.IOException;
import javax.servlet.http.HttpServletRequest;

import ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.ListCard;
import ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.StandardCardInfo;
...
public class TaxBot extends BaseBot {
    ...
    protected Response onLaunch(LaunchRequest launchRequest) {
        // 新建文本卡片
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard textCard = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard("所得税为您服务");
        // 设置链接地址
        textCard.setUrl("www:....");
        // 设置链接内容
    ...
    protected Response onSessionEnded(SessionEndedRequest sessionEndedRequest) {
        ...
        // 构造TextCard
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard textCard = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard("感谢使用所得税服务");
        textCard.setAnchorText("setAnchorText");
        ...
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.StandardCardInfo item1 = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.StandardCardInfo("title1", "content1");
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.StandardCardInfo item2 = new StandardCardInfo("title2", "content2");
    ...
    private Response askLocation() {
        ...
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard textCard = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard("您所在的城市是哪里呢?");
        textCard.setUrl("www:......");
        textCard.setAnchorText("setAnchorText");
    ...
    private Response askSalary() {
        ...
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard textCard = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard("您的税前工资是多少呢?");
        textCard.setUrl("www:......");
    ...
    private Response askComputeType() {
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard textCard = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard("请选择您要查询的种类");
        textCard.setAnchorText("setAnchorText");
    ...
    private Response compute() {
        ...
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard textCard = new TextCard(ret);
        textCard.setAnchorText("setAnchorText");
