...
package ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.pay;

public class ChargeBaiduPay {

    private ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.pay.AuthorizeAttributes authorizeAttributes = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.pay.AuthorizeAttributes();
