...
import ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.audioplayer.control.BaseButton;
...
public class PlayerInfo {
    ...
    // 控件列表
    private ArrayList<ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.audioplayer.control.BaseButton> controls = new ArrayList<>();
     ...
     *            控件列表
     */
    public PlayerInfo(Content content, ArrayList<ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.audioplayer.control.BaseButton> controls) {
     ...
     */
    public ArrayList<ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.audioplayer.control.BaseButton> getControls() {
        return controls;
    }
     ...
     * @return PlayerInfo
     */
    public PlayerInfo setControls(ArrayList<ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.audioplayer.control.BaseButton> controls) {
        this.controls = controls;
        return this;
    }
     ...
     * @return PlayerInfo 播放器界面信息
     */
    public PlayerInfo setLyric(Content.LyricStructure lyric) {
