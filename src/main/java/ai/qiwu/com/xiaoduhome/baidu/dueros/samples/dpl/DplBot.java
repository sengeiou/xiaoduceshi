...
package ai.qiwu.com.xiaoduhome.baidu.dueros.samples.dpl;
...
public class DplBot extends BaseBot {
    ...
    protected Response onLaunch(LaunchRequest launchRequest) {
        ...
        try {
            // 从json文件中初始化Document
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document document = ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document.getDocumentFromPath("../launch.json");

            // RenderDocument指令
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.RenderDocument renderDocument = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.RenderDocument();
    ...
    protected Response onInent(IntentRequest intentRequest) {
        if ("dpl_demo1".equals(intentRequest.getIntentName())) {
            try {
                // 从json文件中初始化Document
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document document = ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document.getDocumentFromPath("../demo1.json");
            ...
            try {
                // 从json文件中初始化Document
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document document = ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document.getDocumentFromPath("../demo2.json");
            ...
            try {
                // 从json文件中初始化Document
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document document = ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document.getDocumentFromPath("../demo3.json");
            ...
            try {
                // 从json文件中初始化Document
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document document = ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document.getDocumentFromPath("../demo4.json");
            ...
            try {
                // 从json文件中初始化Document
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document document = ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document.getDocumentFromPath("../demo5.json");
            ...
            try {
                // 从json文件中初始化Document
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document document = ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document.getDocumentFromPath("../demo6.json");
            ...
            try {
                // 从json文件中初始化Document
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document document = ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document.getDocumentFromPath("../demo7.json");

                // RenderDocument指令
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.RenderDocument renderDocument = new RenderDocument();
                renderDocument.setDocument(document);
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands executeCommands = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands();
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ScrollCommand scrollCommand = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ScrollCommand();
            ...
            try {
                // 从json文件中初始化Document
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.Document document = Document.getDocumentFromPath("../update.json");
                ...
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands executeCommands = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands();
                ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.UpdateComponentCommand updateComponentCommand = new UpdateComponentCommand();
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands executeCommands = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands();
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ScrollCommand scrollCommand = new ScrollCommand();
            ...
            // 回到列表顶部
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands executeCommands = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands();
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ScrollToIndexCommand scrollToIndexCommand = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ScrollToIndexCommand();
            scrollToIndexCommand.setAlign(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ScrollToIndexCommand.AlignType.FIRST).setIndex(1).setComponentId("demo_list_compid");
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ControlMediaCommand controlMediaCommand = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ControlMediaCommand();
            controlMediaCommand.setComponentId("demo_video_compid");
            controlMediaCommand.setCommand(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ControlMediaCommand.ControlMediaCommandType.PAUSE);
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands executeCommands = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands();
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ControlMediaCommand controlMediaCommand = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ControlMediaCommand();
            controlMediaCommand.setCommand(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ControlMediaCommand.ControlMediaCommandType.PLAY).setComponentId("demo_video_compid");
            executeCommands.addCommand(controlMediaCommand);
            this.addDirective(executeCommands);
            ...
            // 收藏
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands executeCommands = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands();
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.SetStateCommand setStateCommand = new SetStateCommand();
            setStateCommand.setState("src").setValue("https://dbp-dict.bj.bcebos.com/dpl%2F%E5%BF%83.png")
                    .setComponentId("demo_image_compid");

            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.AnimationCommand animationCommand = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.AnimationCommand();
            animationCommand.setFrom("40dp").setTo("10dp").setEasing(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.AnimationCommand.EasingType.EASEIN).setAttribute("height")
                    .setDuration(500).setRepeatCount("9").setRepeatMode(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.AnimationCommand.RepeatMode.REVERSE)
                    .setComponentId("demo_image_compid");
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.SetPageCommand setPageCommand = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.SetPageCommand();
            setPageCommand.setPosition(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.SetPageCommand.Position.RELATIVE).setValue(value).setComponentId("demo_move_page_compid");
    ...
    protected Response onUserEvent(final UserEvent userEvent) {
        ...
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.ExecuteCommands executeCommands = new ExecuteCommands();
        ...
        if ("Pager".equals(type)) {
            ...
            if ("1".equals(userEvent.getPayload().getSource().getValue())) {
                controlMediaCommand.setCommand(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ControlMediaCommand.ControlMediaCommandType.PLAY);
            }
            executeCommands.addCommand(controlMediaCommand);
        }
        this.addDirective(executeCommands);
