...
public class AudioPlayerDirective extends Directive {
    ...
    // 多媒体信息
    private ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.AudioItem audioItem;

    /**
     * 默认构造方法
     */
    public AudioPlayerDirective() {
        audioItem = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.AudioItem();
    }
     ...
     *            多媒体信息
     */
    public AudioPlayerDirective(final PlayBehaviorType playBehavior, final ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.AudioItem audioItem) {
    ...
    public AudioPlayerDirective(String url) {
        audioItem = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.AudioItem(url);
    }
    ...
    public AudioPlayerDirective(final PlayBehaviorType playBehavior, final String url, final int offsetInMilliSeconds) {
        this.playBehavior = playBehavior;
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.AudioItem audioItem = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.AudioItem(url, offsetInMilliSeconds);
        this.audioItem = audioItem;
    }
     ...
     */
    public ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.AudioItem getAudioItem() {
        return audioItem;
    }
