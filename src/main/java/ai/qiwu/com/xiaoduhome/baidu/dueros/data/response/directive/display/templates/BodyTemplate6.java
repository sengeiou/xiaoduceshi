...
public class BodyTemplate6 extends BaseTemplate {
    ...
    public BodyTemplate6(String title, String url, String content) {
        super(title);
        this.image = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.display.templates.ImageStructure(url);
     ...
     * @return BodyTemplate6
     */
    public BodyTemplate6 setImage(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.display.templates.ImageStructure image) {
        this.image = image;
        return this;
    }
