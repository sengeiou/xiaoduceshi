...
public class ScrollToElementCommand extends BaseCommand {
    ...
    private ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ScrollToIndexCommand.AlignType align;
    ...
    public ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.commands.ScrollToIndexCommand.AlignType getAlign() {
        return align;
    }
