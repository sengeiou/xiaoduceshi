...
import ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.events.CommonEvent;
...
public class UserEvent extends CommonEvent {
    ...
    // payload
    private final ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.event.Payload payload;
    ...
    private UserEvent(@JsonProperty("requestId") final String requestId,
            ...
            @JsonProperty("payload") final ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.event.Payload payload) {
    ...
    public ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.event.Payload getPayload() {
        return payload;
    }
    ...
    public static final class Builder extends RequestBodyBuilder<Builder, UserEvent> {
        ...
        private ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.dpl.event.Payload payload;
