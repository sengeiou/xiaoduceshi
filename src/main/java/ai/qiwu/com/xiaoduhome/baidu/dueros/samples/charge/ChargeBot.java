...
package ai.qiwu.com.xiaoduhome.baidu.dueros.samples.charge;
...
public class ChargeBot extends BaseBot {
    ...
    protected Response onLaunch(LaunchRequest launchRequest) {
        ...
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard textCard = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard("欢迎来到测试支付");
    ...
    protected Response onInent(IntentRequest intentRequest) {
        ...
        if ("charge".equals(intentRequest.getIntentName())) {
            ...
            // 构造返回的charge指令
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.pay.Charge charge = new Charge("0.01", "sellerOrderId", "productName", "description");
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.pay.Buy buy = new Buy("token", "productId");
    ...
    protected Response onChargeEvent(ChargeEvent chargeEvent) {
        ...
        ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.card.TextCard textCard = new TextCard(purchaseResult);
