...
public class Context {
    ...
    private List<ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.ExpectResponse> expectResponse = new ArrayList<ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.ExpectResponse>();
    ...
    public void setExpectResponses(List<ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.ExpectResponse> expectResponses) {
