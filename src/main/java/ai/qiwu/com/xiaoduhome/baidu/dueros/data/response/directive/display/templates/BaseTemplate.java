...
public abstract class BaseTemplate {
    ...
    // 背景图片
    private ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.display.templates.ImageStructure backgroundImage = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.display.templates.ImageStructure();
    // 卡片的标题
     ...
     */
    public ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.display.templates.ImageStructure getBackgroundImage() {
     ...
     * @return BaseTemplate
     */
    public BaseTemplate setBackgroundImage(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.display.templates.ImageStructure backgroundImage) {
