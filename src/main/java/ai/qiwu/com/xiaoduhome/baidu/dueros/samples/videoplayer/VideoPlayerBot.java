 ...
 */
package ai.qiwu.com.xiaoduhome.baidu.dueros.samples.videoplayer;
...
import ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.Image;
import ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.RenderVideoListVideoItem;
import ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.Stop;
import ai.qiwu.com.xiaoduhome.baidu.dueros.bot.VideoPlayer;
...
public class VideoPlayerBot extends VideoPlayer {
    ...
    protected Response onInent(IntentRequest intentRequest) {
        ...
        if ("video_play_intent".equals(intentRequest.getIntentName())) {
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.Play play = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.Play("http:.....mp4");
            play.setPlayBehavior(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.Play.PlayBehaviorType.REPLACE_ALL);
            play.setToken("token");
            // 也可以链式set信息
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.RenderVideoListVideoItem renderVideoListVideoItem = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.RenderVideoListVideoItem();
            ...
            renderVideoListVideoItem.setImage(new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.Image("http:.....png"));
            renderVideoListVideoItem.setToken("123");

            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.RenderVideoListVideoItem renderVideoListVideoItem1 = new RenderVideoListVideoItem();
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.RenderVideoList renderVideoList = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.RenderVideoList();
            renderVideoList.setBehavior(ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.RenderVideoList.RenderVideoListPlayBehaviorType.REPLACE);
        ...
        // 判断NLU解析的意图名称是否匹配 video_stop_intent
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.Stop stop = new Stop();
        ...
        // 判断NLU解析的意图名称是否匹配 video_stop_intent
            ...
            ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.videoplayer.ClearQueue clear = new ClearQueue("CLEAR_ALL");
