...
import ai.qiwu.com.xiaoduhome.baidu.dueros.data.request.audioplayer.event.*;
import ai.qiwu.com.xiaoduhome.baidu.dueros.model.Request;
import ai.qiwu.com.xiaoduhome.baidu.dueros.model.Response;

/**
 * {@code AudioPlayer}继承自{@link ai.qiwu.com.xiaoduhome.baidu.dueros.bot.BaseBot}类，用于处理端上报的audioplayer事件
 * 
