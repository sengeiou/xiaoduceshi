...
public class Charge extends Directive {
    ...
    private ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.pay.Payload payload = new ai.qiwu.com.xiaoduhome.baidu.dueros.data.response.directive.pay.Payload();
